...
class Login extends Component {
    ...
    handleClick = (event) => {
        ...
        fetch('http://http://ec2-3-237-8-5.compute-1.amazonaws.com:1177/userauth/register/login?email='+this.state.email.toString()+"&password="+this.state.password.toString(), requestOptions)
            .then(response => {
