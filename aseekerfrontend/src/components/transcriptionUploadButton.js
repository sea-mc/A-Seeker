        ...
        return (
            ...
            <Dropzone
                onDrop={ acceptedFiles => {
                    ...
                    alert("http://http://ec2-3-237-8-5.compute-1.amazonaws.com:1177/deepSpeech/media/upload?email='"+cookies.get("email")+"'&filename='"+uploadBox.value+"'");
                    fetch("http://http://ec2-3-237-8-5.compute-1.amazonaws.com:1177/deepSpeech/media/upload?email='"+cookies.get("email")+"'&filename='"+uploadBox.value+"'", {
                        method: 'POST',
                        body: formData
                    })
