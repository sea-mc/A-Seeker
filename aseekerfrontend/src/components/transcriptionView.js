...
class TranscriptionView extends React.Component {
    ...
    componentDidMount() {
        ...
        fetch('http://http://ec2-3-237-8-5.compute-1.amazonaws.com:1177/transcriptions/get/single?email=' + cookies.get("email") + "&title="+this.state.title, requestOptions)
        ...
        fetch('http://http://ec2-3-237-8-5.compute-1.amazonaws.com:1177/deepSpeech/media/get?filename='+this.state.title, requestOptions)
